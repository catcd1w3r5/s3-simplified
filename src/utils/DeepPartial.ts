 ...
 * @param customValue
 */
export function pruneAndMerge(defaultValue: ProvidedConfig, customValue: DeepPartial<ProvidedConfig>): any {
    return {
        ...
        objectCreation: customValue.objectCreation ? {
            ...
            hash: customValue.objectCreation.hash || defaultValue.objectCreation.hash,
